...
class ApprovalIncomingRequest{
  ...
  ApprovalIncomingRequest({
    required this.id,
    required this.boardTitle,
    required this.displayTitle, // New property for display title
  ...
  factory ApprovalIncomingRequest.fromJson(Map<String, dynamic> json) {
    return ApprovalIncomingRequest(
      id: json['id'],
